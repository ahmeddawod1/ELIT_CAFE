...
const menuData = {
    ...
    shisha: [
        { name: "love66", price: "فرش :50 شيكل | عادي :20 شيكل"},
        { name: "ليمون ونعنع", price: " فرش:30 شيكل | عادي :20 شيكل" },
        { name: "بطيخ", price: "فرش :  30شيكل | عادي :18 شيكل" },
        { name: "كيف", price: "فرش :30 شيكل | عادي :18  شيكل" },
        { name: "تفاحتين", price: "فرش : 30شيكل | عادي : 18شيكل" },
        { name: "تفاحتين نخلة", price: "فرش: 30شيكل | عادي :20 شيكل" },
        { name: "بلوبيري", price: "فرش :30 شيكل | عادي :20 شيكل" },
        { name: "سهم وقرفة", price: "فرش:30 شيكل | عادي :18 شيكل" },
        { name: "خلطة شامية", price: "فرش :30 شيكل | عادي :20 شيكل" },

        { name: "سبيشل ELITE", price: "فرش: 35شيكل | عادي :25 شيكل" }
    ...
    mainCourse: [
        { name: "أصابع دجاج كريسبي", price: "35 شيكل" },
