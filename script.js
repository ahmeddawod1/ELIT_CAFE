...
const menuData = {
    ...
    shisha: [
        { name: "love66", price: "فرش: 30 شيكل - عادي: 20 شيكل" },
        { name: "ليمون ونعنع", price: "فرش: 30 شيكل - عادي: 20 شيكل" },
        { name: "بطيخ", price: "فرش: 30 شيكل - عادي: 18 شيكل" },
        { name: "كيف", price: "فرش: 30 شيكل - عادي: 18 شيكل" },
        { name: "تفاحتين", price: "فرش: 30 شيكل - عادي: 18 شيكل" },
        { name: "تفاحتين نخلة", price: "فرش: 30 شيكل - عادي: 20 شيكل" },
        { name: "بلوبيري", price: "فرش: 30 شيكل - عادي: 20 شيكل" },
        { name: "سهم وقرفة", price: "فرش: 30 شيكل - عادي: 18 شيكل" },
        { name: "سبيشل ELITE", price: "فرش: 35 شيكل - عادي: 25 شيكل" }
    ],
    salads: [
    ...
    seafood: [
        ...
        { name: "فيتينا جمبري", price: "50 شيكل" }
    ],
    juices: [
        ...
        { name: "(برتقال , رمان)جيابكا", price: "15 شيكل" },
    ...
    desserts: [
        ...
        {  name: "   كيك السان سبستيان", price: "25 شيكل" },
    ...
    mainCourse: [
        ...
        { name: "ستيك دجاج وايت صوص مع بيستو(صدر دجاج مع وايت صوص ويحان, خضار سوتيه)", price: "40 شيكل", desc: "صدر دجاج مع صوص وايت مشروم، خضار سوتيه" },
    ...
    drinks: [
        ...
        { name: "بقاريـا سـاخنة", price: "7 شيكل" },
